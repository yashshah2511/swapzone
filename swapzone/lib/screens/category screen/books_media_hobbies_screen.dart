// lib/screens/category_screen/books_media_hobbies_screen.dart
import 'dart:io';
...
class BooksMediaHobbiesScreen extends StatefulWidget {
  const BooksMediaHobbiesScreen({super.key});

  @override
  State<BooksMediaHobbiesScreen> createState() => _BooksMediaHobbiesScreenState();
}

class _BooksMediaHobbiesScreenState extends State<BooksMediaHobbiesScreen> {
  final _formKey = GlobalKey<FormState>();

  // Common fields
  final _titleController = TextEditingController();
  final _creatorController = TextEditingController(); // Author / Artist / Creator
  final _brandController = TextEditingController();   // Publisher / Label
  ...
  final Map<String, List<String>> subcategoryFields = {
    "Books": [
      "Type (Novel, Textbook, Children’s Book, Comics, etc.)",
      "Author",
      "Language",
      "ISBN (optional)",
    ...
    "Music": [
      "Type (CD, Vinyl, Cassette, Digital Code)",
      "Artist / Band",
      "Album Name",
      "Release Year",
      "Genre"
    ...
    "Collectibles": [
      "Type (Cards, Stamps, Coins, Figurines, etc.)",
      "Edition / Series",
      "Rarity / Limited Edition (Yes/No)",
      "Year of Release"
    ],
  };

  // Colors
  final Color teal = const Color(0xFF009688); // deep purple tone
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Books, Media & Hobbies", style: TextStyle(color: Colors.white)),
      ),
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildTextField("Author / Artist / Creator", _creatorController, icon: Icons.person),
                      const SizedBox(height: 12),
                      _buildTextField("Brand / Publisher / Label", _brandController, icon: Icons.business),
                      const SizedBox(height: 12),
                      Row(
                        children: [
