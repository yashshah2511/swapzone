// lib/screens/category screen/sports_screen.dart
import 'dart:io';
...
class _SportsScreenState extends State<SportsScreen> {
  ...
  final Map<String, List<String>> subcategoryFields = {
    "Fitness Gear": [
      "Type (Dumbbell, Treadmill, Resistance Band, etc.)",
      "Weight / Resistance Level",
      "Dimensions / Size",
      "Material (Rubber, Steel, Foam, etc.)"
    ],
    "Outdoor Equipment": [
      "Type (Tent, Backpack, Climbing Gear, etc.)",
      "Capacity (e.g., 2-person tent, 30L backpack)",
      "Material (Nylon, Polyester, Canvas, etc.)",
      "Waterproof / Weatherproof (Yes/No)"
    ],
    "Bicycles": [
      "Type (Road, Mountain, Hybrid, Electric)",
      "Frame Material (Aluminum, Carbon, Steel)",
      "Frame Size (inches/cm)",
      "Wheel Size (26\", 29\")",
      "Gears / Speed Levels",
      "Brake Type (Disc, V-brake, etc.)"
    ],
    "Camping": [
      "Type (Sleeping Bag, Stove, Lantern, Cooler, etc.)",
      "Capacity (1-person, family size)",
      "Weight / Portability",
      "Power Source (Battery, Gas, Solar, Manual)"
    ],
  };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text("Sports & Outdoors",
                  ...
                  child: Column(
                    children: [
                      _buildTextField("Title", _titleController,
                          required: true, icon: Icons.label),
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Details for $selectedSubcategory",
                          style: titleStyle),
