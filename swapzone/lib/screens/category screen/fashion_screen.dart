// lib/screens/category screen/fashion_screen.dart
import 'dart:io';
...
class _FashionScreenState extends State<FashionScreen> {
  ...
  Future<void> _submitProduct() async {
    ...
    if (selectedSubcategory == null) {
      _showDialog("Error", "Please select a subcategory");
      return;
    }

    final price = double.tryParse(_priceController.text);
    if (price == null) {
      _showDialog("Error", "Please enter a valid price");
      return;
    }
    ...
    if (response['success']) {
      _showDialog("Success", "✅ Product Created");
