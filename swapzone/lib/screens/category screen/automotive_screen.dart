// lib/screens/category screen/automotive_screen.dart
import 'dart:io';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text("Automotive", style: TextStyle(color: Colors.white)),
      ),
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildTextField("Brand / Manufacturer", _brandController, icon: Icons.business),
                      const SizedBox(height: 12),
                      Row(
                        children: [
