// lib/screens/category screen/electronics_screen.dart
import 'dart:io';
...
class _ElectronicsScreenState extends State<ElectronicsScreen> {
  ...
  final Map<String, List<String>> subcategoryFields = {
    ...
    "Wearables": ["Device Type", "Compatibility", "Battery Life", "Water Resistance"],
    "Cameras": ["Type", "Resolution", "Lens Included", "Video Resolution", "Accessories"],
    "Accessories": ["Type", "Compatibility", "Condition", "Color"],
  };
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text("Electronics & Gadgets", style: TextStyle(color: Colors.white)),
      ),
